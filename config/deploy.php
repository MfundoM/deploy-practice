...
//            'logs:clear',
    ...
    */
    ...
    'options' => [
        ...
        'repository'               => env('DEPLOYER_REPO', 'git@bitbucket.org:username/repo.git'),
        'branch'                   => env('DEPLOYER_BRANCH', 'master'),
        'php_fpm_service'          => env('DEPLOYER_FPM', 'php7.4-fpm'),
        'default_timeout'          => 360,
        'keep_releases'            => 5,
        'release_name'             => date('YmdHi'),
        'composer_action'          => 'update',
        'composer_option'         => '{{composer_action}}',
        'composer_actions'         => 'install',
        'composer_options'          => '{{composer_actions}} --verbose --prefer-dist --no-progress --no-interaction --no-dev --optimize-autoloader',
...
//            'user'         => env('DEPLOYER_USER', 'laravel'),
//            'port'         => env('DEPLOYER_PORT', 22),
//            'identityFile' => '~/.ssh/id_rsa',
//            'forwardAgent' => true,
//            'multiplexing' => true,

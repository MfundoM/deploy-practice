...
class ActionEvent extends Model
{
     ...
     * @return void
     */
    public static function createForModels(ActionRequest $request, Action $action, $batchId, Collection $models, $status = 'running')
    {
     ...
     * @return array
     */
    public static function defaultAttributes(ActionRequest $request, Action $action, $batchId, $status = 'running')
    {
